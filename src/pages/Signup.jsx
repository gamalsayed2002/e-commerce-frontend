...
export default function Signup() {
  ...
  return (
    <div className="flex flex-col justify-center py-12 sm:px-6 lg:px-8 mx-auto max-w-[90%]">
      <motion.div
      ...
      >
        <div className="bg-gray-800 py-8 px-4 shadow sm:rounded-lg sm:px-10 rounded-2xl">
